...
export function PaginationList({ className, ...props }: React.JSX.IntrinsicElements['div']) {
	return <div {...props} className={twMerge('hidden gap-x-1 sm:flex', className)} />
}
...
export function PaginationPrevious({
	...
	return (
		<Button asChild variant='plain'>
			<Link
				{...props}
				className={twMerge('px-3.5 outline-offset-0 hover:no-underline', className)}
			>
				<ChevronLeftIcon />
...
export function PaginationNext({
	...
	return (
		<Button asChild variant='plain'>
			<Link
				{...props}
				className={twMerge('px-3.5 outline-offset-1 hover:no-underline', className)}
			>
				{label}
				<ChevronRightIcon />
			</Link>
